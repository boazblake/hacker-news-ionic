...
var Comment = {
  view: function view(_ref) {
    ...
    }, m("ion-card-header", m("ion-grid", m("ion-row.ion-justify-content-center.ion-align-items-center", m("ion-col.", // { slot: "start" },
    m("ion-chip", {
      color: "primary"
    }, user)), m("ion-col.", // { slot: "end" },
    m("ion-note", time_ago))))), m("ion-card-content", m.trust(mdl.markup.render(content)), comments_count ? m("ion-button", {
      expand: "full",
