...
var match = function match(mdl) {
  return function (_ref, path) {
    ...
    if (key) {
      ...
      mdl.state.title((0, _ramda.prop)("title", mdl.routes.find((0, _ramda.propEq)("name", route))));
      mdl.state.id(null);
    }
  };
};
...
var showComments = function showComments(mdl, key, level) {
  return mdl.state.comment["".concat(key, "-").concat(level)] || false;
};
...
var Comment = {
  ...
  view: function view(_ref2) {
    ...
    }, m("ion-card-header", m("ion-grid", m("ion-row.ion-justify-content-center.ion-align-items-center", m("ion-col.", m("ion-chip", {
      onclick: function onclick(e) {
        return mdl.toggleUser(mdl)(user, e);
      },
      color: "primary"
    }, user)), m("ion-col.", m("ion-note", time_ago))))), m("ion-card-content", m.trust(mdl.markup.render(content)), comments_count ? m("ion-button", {
      expand: "full",
    ...
    }, ["".concat(comments_count, " comments"), showComments(mdl, key, level) ? m("ion-icon", {
      slot: "end",
      name: "chevron-up-outline"
    }) : m("ion-icon", {
      slot: "end",
      name: "chevron-down-outline"
    })]) : null, showComments(mdl, key, level) && comments.map(function (c, idx) {
      return m(Comment, {
        key: idx,
        comment: c,
        mdl: mdl
...
var Header = {
  view: function view(_ref) {
    var mdl = _ref.attrs.mdl;
    return m("ion-header", m("ion-toolbar.ion-justify-content-center.ion-align-items-center", mdl.state.id() ? [m("ion-back-button", {
      text: "",
      slot: "start",
      defaultHref: "/news",
      onclick: function onclick(e) {
...
var Footer = function Footer(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      return m("ion-footer.ion-no-border", {
        slot: "bottom"
      }, m.apply(void 0, ["ion-tabs"].concat(_toConsumableArray(Routes.map(function (_ref4) {
        var name = _ref4.name;
        return m("ion-tab", {
          tab: "".concat(name)
        });
        ...
        return m("ion-tab-button", {
          ...
          tab: "".concat(name)
        }, [m("ion-label", title.toUpperCase()), m("ion-icon", {
          name: icon
        })]);
      })), [m("ion-tab-button", {
        onclick: function onclick() {
...
var Layout = function Layout(_ref6) {
  ...
  return {
    view: function view(_ref7) {
      ...
      return m("ion-app", children && m("ion-page", [m(Header, {
        mdl: mdl
      }), m("ion-content", {
        fullscreen: true
      }, children), m(Footer, {
...
;require.register("components/popover.js", function(exports, require, module) {
"use strict";
...
var Popover = function Popover() {
  return {
    ...
    oncreate: function oncreate(_ref2) {
      var _mdl$data, _mdl$data$user;

      var mdl = _ref2.attrs.mdl,
          dom = _ref2.dom;
      return ((_mdl$data = mdl.data) === null || _mdl$data === void 0 ? void 0 : (_mdl$data$user = _mdl$data.user) === null || _mdl$data$user === void 0 ? void 0 : _mdl$data$user.data) && _core.popoverController.create({
    ...
    view: function view(_ref4) {
      var mdl = _ref4.attrs.mdl;
      return m("ion-popover", m("ion-buttons", m("ion-icon", {
        slot: "icons-only",
        name: "close"
      })), m("", mdl.modal.title()), // m("ion-content.ion-padding",
      mdl.modal.contents() //  )
      );
    }
  };
...
var Post = {
  view: function view(_ref) {
    ...
    return m("ion-item", {
      ...
      slot: "end"
    }, "".concat(points, " pts")), comments_count > 0 && m("ion-badge", {
      slot: "start"
...
var togglePopover = function togglePopover(e, mdl) {
  mdl.state.event = e;
  ...
  return {
    ...
    view: function view(_ref2) {
      ...
      return [!data.comments ? m("ion-progress-bar[type='indeterminate']") : m("ion-list", {
        route: route
      }, data.length && m("ion-progress-bar[type='indeterminate']"), m("ion-refresher", {
...
var Posts = function Posts() {
  return {
    ...
    view: function view(_ref2) {
      var mdl = _ref2.attrs.mdl;
      var route = mdl.state.route;
      var page = mdl.data[route];
      var data = page.data;
      return m("ion-content", {
        oncreate: function oncreate(_ref3) {
          var dom = _ref3.dom;
          return dom.scrollToPoint(0, page.pos);
        },
        id: "me",
        route: route,
        scrollEvents: true,
        onionScroll: function onionScroll(_ref4) {
          var currentY = _ref4.detail.currentY;
          return page.pos = currentY;
        }
      }, [!data ? m("ion-progress-bar[type='indeterminate']") : m("ion-list", m("ion-refresher", {
        onionRefresh: function onionRefresh(e) {
          setTimeout(function () {
            console.log("Async operation has ended");
            e.target.complete();
